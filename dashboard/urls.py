...
urlpatterns = [
    ...
    path('super-admin/users/create/', views.admin_create_client_view, name='admin-create-client'),
    path('super-admin/users/create/success/', views.admin_client_created_success_view, name='admin-client-created-success'),
